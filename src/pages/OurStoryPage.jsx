  ...
  return (
    <div style={{ background: C.surface }}>
      ...
      <section style={{
        ...
        <Leaf style={{ position: 'absolute', top: '-6%', left: '2%', width: 110, color: C.primary, animation: 'leafFloat1 9s ease-in-out infinite' }} />
        <Leaf style={{ position: 'absolute', top: '5%', right: '3%', width: 85, color: C.primary, animation: 'leafFloat2 12s ease-in-out infinite', transform: 'rotate(-25deg)' }} />
        <SmallLeaf style={{ position: 'absolute', bottom: '5%', left: '10%', width: 55, color: C.primary, animation: 'leafFloat3 8s ease-in-out infinite 1s', transform: 'rotate(20deg)' }} />
        <SmallLeaf style={{ position: 'absolute', bottom: '10%', right: '12%', width: 45, color: C.secondary, animation: 'leafFloat1 10s ease-in-out infinite 2s', transform: 'rotate(-40deg)' }} />
        <JasmineFlower style={{ position: 'absolute', top: '25%', left: '8%', width: 50, color: C.secondary, animation: 'leafFloat2 11s ease-in-out infinite 0.5s' }} />
        <JasmineFlower style={{ position: 'absolute', top: '15%', right: '15%', width: 44, color: C.primary, animation: 'leafFloat3 9s ease-in-out infinite 1.5s' }} />
        <JasmineFlower style={{ position: 'absolute', bottom: '0%', right: '35%', width: 38, color: C.secondary, animation: 'leafFloat1 13s ease-in-out infinite 3s', opacity: 0.7 }} />
        <div style={{ maxWidth: 760, margin: '0 auto', padding: '0 32px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          <p style={{ fontFamily: 'Dancing Script', fontWeight: 600, fontSize: 28, color: C.secondary, margin: '0 0 12px' }}>
            Where it all began
          </p>
          <h1 style={{
