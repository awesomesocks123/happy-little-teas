    ...
    <div style={{ position: "relative" }}>
      ...
      >
        {featuredDrinks.map((d, i) => {
          ...
          if (isTop) {
            const tx =
              exitDir === "left" ? -620 : exitDir === "right" ? 620 : dragX;
            const rot =
              exitDir === "left"
                ? -28
                : exitDir === "right"
            ...
            transition = isDragging.current
              ? "none"
              : exitDir
                ? "transform 0.42s cubic-bezier(0.4,0,0.8,1)"
                ...
                <>
                  <div
                    style={{
                      ...
                      opacity: dragX > 30 ? Math.min(1, (dragX - 30) / 48) : 0,
                  ...
                  <div
                    style={{
                      ...
                      transform: "rotate(13deg)",
                      opacity:
                        dragX < -30 ? Math.min(1, (-dragX - 30) / 48) : 0,
                      transition: "opacity 0.08s",
                    }}
                  >
                    NEXT →
...
function Container({ children, style, className }) {
  return (
    <div
      className={className}
      style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px", ...style }}
    >
      {children}
    </div>
  );
...
export default function HomePage() {
  ...
  return (
    <div style={{ background: C.surface, overflowX: "hidden" }}>
      ...
      >
        ...
        <Leaf
          style={{
            ...
            width: 70,
            color: C.primary,
            animation: "leafFloat3 13s ease-in-out infinite 1s",
        ...
        <SmallLeaf
          style={{
            ...
            width: 60,
            color: C.primary,
            animation: "leafFloat3 7s ease-in-out infinite",
        ...
        <SmallLeaf
          style={{
            ...
            width: 50,
            color: C.primary,
            animation: "leafFloat1 8s ease-in-out infinite 2s",
        ...
        <SmallLeaf
          style={{
            ...
            width: 45,
            color: C.primary,
            animation: "leafFloat2 10s ease-in-out infinite 1s",
          }}
        />
        <SmallLeaf
          style={{
            ...
            width: 40,
            color: C.secondary,
            animation: "leafFloat3 12s ease-in-out infinite 3s",
        ...
        <JasmineFlower
          style={{
            ...
            width: 52,
            color: C.secondary,
            animation: "leafFloat2 10s ease-in-out infinite 0.5s",
          }}
        />
        <JasmineFlower
          style={{
            ...
            width: 44,
            color: C.primary,
            animation: "leafFloat1 12s ease-in-out infinite 2s",
          }}
        />
        <JasmineFlower
          style={{
            ...
            width: 36,
            color: C.secondary,
            animation: "leafFloat3 9s ease-in-out infinite 1s",
            opacity: 0.7,
          }}
        />
        {/* Bottom-edge cluster */}
        <Leaf
          style={{
            ...
            width: 88,
            color: C.primary,
            animation: "leafFloat1 10s ease-in-out infinite 0.5s",
            transform: "rotate(30deg)",
          }}
        />
        <Leaf
          style={{
            ...
            width: 66,
            color: C.primary,
            animation: "leafFloat2 12s ease-in-out infinite 1.5s",
        ...
        <JasmineFlower
          style={{
            ...
            width: 46,
            color: C.secondary,
            animation: "leafFloat1 11s ease-in-out infinite 2s",
          }}
        />
        <SmallLeaf
          style={{
            ...
            width: 55,
            color: C.primary,
            animation: "leafFloat2 9s ease-in-out infinite 1s",
        ...
        <JasmineFlower
          style={{
            ...
            width: 40,
            color: C.primary,
            animation: "leafFloat3 13s ease-in-out infinite 0.5s",
          }}
        />
        <SmallLeaf
          style={{
            ...
            width: 44,
            color: C.secondary,
            animation: "leafFloat1 10s ease-in-out infinite 3s",
            transform: "rotate(20deg)",
          }}
        />
        ...
        {[
          ...
          <BobaBubble
            ...
            style={{
              ...
              ...b,
              animation: `bobaBob ${b.anim} ease-in-out infinite ${i * 2}s`,
            }}
          />
        ))}
          ...
          >
            ...
            <p
              style={{
                ...
                transition:
                  "opacity 0.7s ease 0.15s, transform 0.7s cubic-bezier(0.22,1,0.36,1) 0.15s",
              }}
            >
              Handcrafted boba, real fruit, real milk, real cane sugar.
            </p>
            ...
            >
              <button
                ...
                style={{
                  ...
                  fontSize: 15,
                  cursor: "pointer",
                  boxShadow: "0 4px 20px rgba(76,100,87,0.3)",
                  transition: "transform 0.15s, box-shadow 0.15s",
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "scale(1.04)";
                  e.currentTarget.style.boxShadow =
                    "0 6px 28px rgba(76,100,87,0.4)";
                }}
                onMouseLeave={(e) => {
      ...
      >
        ...
        <Leaf
          style={{
            ...
            width: 100,
            color: "#b3cdbd",
            animation: "leafFloat3 10s ease-in-out infinite 2s",
          }}
        />
        <Leaf
          style={{
            ...
            width: 70,
            color: "#b3cdbd",
            animation: "leafFloat1 14s ease-in-out infinite 1s",
            transform: "rotate(-20deg)",
          }}
        />
        <SmallLeaf
        ...
        <SmallLeaf
          style={{
            ...
            width: 55,
            color: "#b3cdbd",
            animation: "leafFloat3 11s ease-in-out infinite 2.5s",
            transform: "rotate(30deg)",
          }}
        />
        <SmallLeaf
          style={{
            ...
            width: 48,
            color: "#b3cdbd",
            animation: "leafFloat2 8s ease-in-out infinite 1s",
          }}
        />
        <JasmineFlower
          style={{
            ...
            width: 60,
            color: "#d4a57a",
            animation: "leafFloat1 11s ease-in-out infinite 1s",
          }}
        />
        <JasmineFlower
          style={{
            ...
            width: 50,
            color: "#d4a57a",
            animation: "leafFloat2 9s ease-in-out infinite",
          }}
        />
        <JasmineFlower
          style={{
            ...
            width: 44,
            color: "#d4a57a",
            animation: "leafFloat3 10s ease-in-out infinite 3s",
          }}
        />
        <JasmineFlower
          style={{
            ...
            width: 38,
            color: "#d4a57a",
            animation: "leafFloat1 13s ease-in-out infinite 0.5s",
          }}
        />
        {/* Bottom-edge cluster */}
        <Leaf
          style={{
            ...
            width: 90,
            color: "#b3cdbd",
            animation: "leafFloat2 11s ease-in-out infinite 1s",
        ...
        <SmallLeaf
          style={{
            ...
            width: 52,
            color: "#b3cdbd",
            animation: "leafFloat1 8s ease-in-out infinite 1.5s",
            transform: "rotate(-30deg)",
          }}
        />
        <Leaf
          style={{
            ...
            width: 75,
            color: "#b3cdbd",
            animation: "leafFloat3 13s ease-in-out infinite 3s",
            transform: "rotate(-15deg)",
          }}
        />
            ...
            {reviews.map((r, i) => (
              <Reveal key={r.name} delay={i * 100}>
                <div
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow =
                      "0 8px 32px rgba(76,100,87,0.12)";
      ...
      >
        ...
        <SmallLeaf
          style={{
            ...
            width: 36,
            color: C.secondary,
            animation: "leafFloat3 9s ease-in-out infinite 2s",
            opacity: 0.35,
            transform: "rotate(20deg)",
          }}
        />
        <Reveal>
          ...
          <button
            ...
            style={{
              ...
              fontSize: 16,
              cursor: "pointer",
              boxShadow: "0 6px 24px rgba(76,100,87,0.3)",
              transition: "transform 0.15s, box-shadow 0.15s",
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.transform = "scale(1.05)";
              e.currentTarget.style.boxShadow =
                "0 8px 32px rgba(76,100,87,0.4)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.transform = "scale(1)";
              e.currentTarget.style.boxShadow =
                "0 6px 24px rgba(76,100,87,0.3)";
            }}
          >
            Order Now
          </button>
      ...
      <section
        id="locations"
        style={{ padding: "80px 0", borderTop: `1px solid ${C.outline}` }}
      >
        <Container>
          <Reveal>
