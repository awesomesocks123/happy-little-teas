    ...
    >
      ...
      <Leaf
        style={{
          ...
          width: 110,
          color: G,
          animation: "leafFloat2 13s ease-in-out infinite",
        }}
      />
      <Leaf
        style={{
          ...
          width: 90,
          color: G,
          animation: "leafFloat1 10s ease-in-out infinite 1s",
      ...
      <JasmineFlower
        style={{
          ...
          width: 48,
          color: B,
          animation: "leafFloat1 12s ease-in-out infinite 1.5s",
        }}
      />
      <JasmineFlower
        style={{
      ...
      <JasmineFlower
        style={{
          ...
          width: 44,
          color: B,
          animation: "leafFloat3 11s ease-in-out infinite 2s",
        }}
      />
      <JasmineFlower
        style={{
      ...
      <SmallLeaf
        style={{
          ...
          width: 48,
          color: G,
          animation: "leafFloat2 8s ease-in-out infinite 1.5s",
          transform: "rotate(-25deg)",
        }}
      />
        ...
        <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
          {[
            ...
            <a
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.color = primaryContainer)
              }
